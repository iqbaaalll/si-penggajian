                    ...
                    <div class="inline-flex mb-4">
                        <select id="reportType" name="reportType"
                            ...
                            <option value="transferList"
                                data-url="{{ route('admin.exportTransferList', ['id' => $payrollPeriod->id]) }}">
                                Transfer List Report</option>
                            <option value="taxReport"
                                data-url="{{ route('admin.exportTaxReport', ['id' => $payrollPeriod->id]) }}">Tax
                                Report</option>
                            <option value="bpjsReport"
                                data-url="{{ route('admin.exportBpjsReport', ['id' => $payrollPeriod->id]) }}">BPJS
                                Report</option>
                        </select>
