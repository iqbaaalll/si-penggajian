                ...
                <div class="container px-6 mx-auto grid">
                    <div class="container mx-auto flex justify-between items-center">
                        ...
                        <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                            ...
                            {{ \Carbon\Carbon::parse($payroll->payrollMonth)->format('F Y') }}
                        </h2>
                        <a href={{ route('user.payrollHistory') }}
                            ...
                            <span class="ml-2 mr-4 text-sm">Back to Payroll History</span>
                        </a>
                    </div>
                    @include('layouts.payrollhistory-table')
                </div>
            </main>
        </div>
    </div>
